...
__decorate([
    (0, typeorm_1.Column)("uuid", { name: "journal_entry_id", unique: true }),
    __metadata("design:type", String)
], ReviewEntity.prototype, "journalEntryId", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.OneToOne)(() => JournalEntryEntity_1.JournalEntryEntity, (journalEntry) => journalEntry.review, {
        onDelete: "CASCADE",
    }),
...
], ReviewEntity.prototype, "journalEntry", void 0);
exports.ReviewEntity = ReviewEntity = __decorate([
    (0, typeorm_1.Index)("review_pkey", ["id"], { unique: true }),
    (0, typeorm_1.Index)("review_journal_entry_id_key", ["journalEntryId"], { unique: true }),
    (0, typeorm_1.Entity)("review", { schema: "public" })
], ReviewEntity);
